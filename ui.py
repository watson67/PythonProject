...
def page1(root, base_frame, theme):
    ...
    browse_btn = tk.Button(frame2, textvariable=browse_txt, padx = 50 , pady = 20, command=lambda:test1(), font="Raleway", bg=theme[0], fg=theme[1])
    browse_txt.set("Recommandations")
    browse_btn.pack(side= tk.LEFT)

    #Bouton annuler
    txt = tk.StringVar()
    browse_btn = tk.Button(frame2, textvariable=txt,padx = 49 , pady = 20, command=lambda:clear_frame(base_frame), font="Raleway", bg=theme[0], fg=theme[1])
